...
class CSMReplicationHelm(storage.StorageBaseHelm):
    """ Class to encapsulate helm operations for the CSM Replication chart. """

    CHART = app_constants.HELM_CHART_CSM_REPLICATION
    HELM_RELEASE = app_constants.FLUXCD_HELMRELEASE_CSM_REPLICATION
