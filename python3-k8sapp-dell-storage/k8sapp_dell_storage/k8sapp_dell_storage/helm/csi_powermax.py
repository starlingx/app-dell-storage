...
class CSIPowerMaxHelm(storage.StorageBaseHelm):
    """ Class to encapsulate helm operations for the CSI PowerMax chart. """

    CHART = app_constants.HELM_CHART_CSI_POWERMAX
    HELM_RELEASE = app_constants.FLUXCD_HELMRELEASE_CSI_POWERMAX
