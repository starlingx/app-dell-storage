...
class CSIPowerScaleHelm(storage.StorageBaseHelm):
    """ Class to encapsulate helm operations for the CSI Powerscale chart. """

    CHART = app_constants.HELM_CHART_CSI_POWERSCALE
    HELM_RELEASE = app_constants.FLUXCD_HELMRELEASE_CSI_POWERSCALE
