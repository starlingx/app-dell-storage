...
class CSIPowerStoreHelm(base.FluxCDBaseHelm):
    """ Class to encapsulate helm operations for the CSI PowerStore chart. """

    CHART = app_constants.HELM_CHART_CSI_POWERSTORE

    HELM_RELEASE = app_constants.FLUXCD_HELMRELEASE_CSI_POWERSTORE
    ...
    def execute_manifest_updates(self, operator):
        ...
        # Only disable if specified by the user.
